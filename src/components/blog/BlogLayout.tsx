...
export default function BlogLayout({ title, description, date, publishedDate, readTime, slug, children }: BlogLayoutProps) {
      ...
      <div className="flex flex-col lg:flex-row gap-12 relative">
        ...
        <aside className="w-full lg:w-64 flex-shrink-0 space-y-8 lg:sticky lg:top-24 h-fit">
          ...
          <div className="p-4 bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 rounded-xl text-center">
            <p className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Free Bulk File Renamer</p>
